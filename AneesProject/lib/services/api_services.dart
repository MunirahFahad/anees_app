...
class ApiService {
  ...
  static const String _apiKey  = 'YOUR_LLM_KEY_HERE';
...
المطلوب:
- اكتب 4 إلى 6 جمل
- ابدأ بوصف واضح يساعد المستخدم على تخيّل شكل المكان (الحجم، المساحة، ترتيب المباني)
- استخدم وصفًا واقعيًا ودقيقًا، وليس خياليًا أو مبالغًا فيه
- اشرح أهمية المكان تاريخيًا بشكل بسيط وواضح
- اربط بين شكل المكان ووظيفته في الماضي
- اجعل الأسلوب هادئًا وسلسًا ومناسبًا للاستماع الصوتي
- استخدم جمل متوسطة الطول (ليست قصيرة جدًا ولا طويلة جدًا)
- تجنب أي تعبير يعتمد على الرؤية المباشرة (مثل: انظر، ترى)
- اجعل المستخدم يشعر وكأنه يفهم المكان من خلال الوصف فقط
""";
  }
